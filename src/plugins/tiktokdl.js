          ...
          message: {
            ...
            interactiveMessage: proto.Message.InteractiveMessage.create({
              ...
              footer: proto.Message.InteractiveMessage.Footer.create({
                text: "𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐄𝐃 𝐁𝐘 𝘿𝙀𝘼𝙏𝙃𝙂𝙐𝙉"
              }),
              header: proto.Message.InteractiveMessage.Header.create({
                 ...(await prepareWAMessageMedia({ image: { url: `https://raw.githubusercontent.com/toge012345/DEATHGUN/main/deathgun.jpg` } }, { upload: Matrix.waUploadToServer })),
                title: "",
                gifPlayback: true,
                subtitle: "",
      ...
      if (selectedMedia) {
        try {
          ...
          if (type === 'video' && fileSizeInMB <= 300) {
            content = { video: finalMediaBuffer, mimetype: 'video/mp4', caption: '> 𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐄𝐃 𝐁𝐘 𝘿𝙀𝘼𝙏𝙃𝙂𝙐𝙉' };
          } else if (type === 'audio' && fileSizeInMB <= 300) {
            content = { audio: finalMediaBuffer, mimetype: 'audio/mpeg', caption: '> 𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐄𝐃 𝐁𝐘 𝘿𝙀𝘼𝙏𝙃𝙂𝙐𝙉' };
          }
