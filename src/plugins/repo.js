...
const searchRepo = async (m, Matrix) => {
  ...
  if (validCommands.includes(cmd)) {
    const repoUrl = `https://api.github.com/repos/Deathsgun0001/Deathgun`;
          ...
          interactiveMessage: proto.Message.InteractiveMessage.create({
            ...
            header: proto.Message.InteractiveMessage.Header.create({
              ...(await prepareWAMessageMedia({
                image: {
                  url: 'https://raw.githubusercontent.com/deathsgun0001/DEATHGUN/main/deathgun.jpg',
                },
            ...
            nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
              buttons: [
                ...
                },
                {
                  name: 'cta_url',
                  buttonParamsJson: JSON.stringify({
                    display_text: '𝑆𝑡𝑖𝑔𝑚𝑎 𝑆𝐴𝑆𝐴𝐾𝐼 ',
                    url: 'https://whatsapp.com/channel/0029VaoOYCpHgZWcZwhD6V21',
                  }),
                },
              ],
            }),
